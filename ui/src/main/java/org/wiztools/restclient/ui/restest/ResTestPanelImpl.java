...
class ResTestPanelImpl extends JPanel implements ResTestPanel {
    ...
    private final Icon ICON_DEFAULT = SVGLoad.scaledIcon("org/wiztools/restclient/test/s_contrast_low.svg");
    private final Icon ICON_SUCCESS = SVGLoad.scaledIcon("org/wiztools/restclient/test/s_accept.svg");
    private final Icon ICON_FAILURE = SVGLoad.scaledIcon("org/wiztools/restclient/test/s_cross.svg");
